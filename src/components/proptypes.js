...
export const buttonKinds = Proptypes.oneOf(['primary', 'info', 'secondary', 'danger', 'warning', 'dark', 'light', 'success', 'icon']);
...
const creatorProptypes = {
  id: Proptypes.string.isRequired,
  creator_type: Proptypes.string.isRequired,
  creator_name: Proptypes.string.isRequired,
};
...
export const ticketShowModalProptypes = {
  ...
  loadingKey: Proptypes.oneOf(['none', 'title', 'ticketIndex', 'attachment', 'ticketShow']).isRequired,
